...
ALTER TABLE resumes ADD COLUMN IF NOT EXISTS moderation_status TEXT NOT NULL DEFAULT 'clean';
ALTER TABLE resumes ADD COLUMN IF NOT EXISTS moderation_notes TEXT NOT NULL DEFAULT '';
ALTER TABLE resumes ADD COLUMN IF NOT EXISTS moderation_updated_by UUID REFERENCES users(id) ON DELETE SET NULL;
ALTER TABLE resumes ADD COLUMN IF NOT EXISTS moderation_updated_at TIMESTAMPTZ;
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS experience_level TEXT NOT NULL DEFAULT 'mid';
